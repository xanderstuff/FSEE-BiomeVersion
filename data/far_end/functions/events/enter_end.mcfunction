...
# Sound effect(s)
execute if score foka.config foka.config.enter_end_effects.sounds matches 1 at @s run playsound block.portal.travel ambient @s ~ ~ ~ 0.14 1.2
...
particle explosion_emitter ~ ~1.2 ~
