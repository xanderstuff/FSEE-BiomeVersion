...
execute as @e[type=minecraft:end_crystal,distance=..5,tag=!fe.respawn_crystal] if predicate far_end:mobs/ender_dragon/respawn/end_crystal_north run tag @s add fe.respawn_crystal
execute as @e[type=minecraft:end_crystal,distance=..5,tag=!fe.respawn_crystal] if predicate far_end:mobs/ender_dragon/respawn/end_crystal_east run tag @s add fe.respawn_crystal
...
execute store result score @s fe.count run execute if entity @e[type=minecraft:end_crystal,distance=..5,tag=fe.respawn_crystal]
