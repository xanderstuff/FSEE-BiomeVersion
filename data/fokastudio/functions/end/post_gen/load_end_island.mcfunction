...
execute in minecraft:the_end run setblock -32 58 -32 minecraft:structure_block[mode=load]{author:"FokaStudio",ignoreEntities:0b,integrity:1.0f,metadata:"",mirror:"NONE",mode:"LOAD",name:"fokastudio:end/end_island_lower",posX:-80,posY:-50,posZ:-80,powered:0b,rotation:"NONE",seed:0L,showair:0b,showboundingbox:0b,sizeX:160,sizeY:80,sizeZ:160} replace
execute in minecraft:the_end run setblock -32 59 -32 redstone_block replace
