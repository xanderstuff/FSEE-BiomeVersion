...
execute as @e[type=#fokastudio:end/stronghold/hostile_buffable,predicate=fokastudio:end/locations/in_stronghold,tag=!foka.stronghold_enemy_buffed] run function fokastudio:end/stronghold/buff_enemies
