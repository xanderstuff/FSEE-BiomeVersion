attribute @s generic.armor modifier add 39147e49-acc7-4a91-96f1-af1c41b25e0d "foka.stronghold_defense_buff" 6 add
attribute @s generic.armor modifier add de9a7ae1-539e-416f-9bf5-001112b08a87 "foka.stronghold_attack_buff" 2 add
