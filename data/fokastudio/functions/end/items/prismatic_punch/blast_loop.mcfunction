...
execute anchored eyes facing entity @e[type=!#fokastudio:end/invalid_targets,limit=1,sort=nearest,distance=..12] eyes positioned ^ ^ ^2.2 rotated as @s positioned ^ ^ ^5 facing entity @s eyes facing ^ ^ ^-1 positioned as @s run tp @s ^ ^ ^1 ~ ~

# Detonation
execute anchored eyes if entity @e[type=!#fokastudio:end/invalid_targets,distance=..3] if score @s foka.items.prismatic_punch.marker_age matches 5.. run function fokastudio:end/items/prismatic_punch/detonate
