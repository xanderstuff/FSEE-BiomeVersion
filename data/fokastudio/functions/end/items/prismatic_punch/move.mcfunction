execute if score @s foka.items.prismatic_punch.marker_age matches ..40 run function fokastudio:end/items/prismatic_punch/move/1
execute if score @s foka.items.prismatic_punch.marker_age matches 41..80 run function fokastudio:end/items/prismatic_punch/move/0.8
execute if score @s foka.items.prismatic_punch.marker_age matches 81..120 run function fokastudio:end/items/prismatic_punch/move/0.6
