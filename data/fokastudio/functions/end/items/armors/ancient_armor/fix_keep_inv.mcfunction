...
attribute @s[tag=foka.ancient_armor_bonus_active] generic.attack_damage modifier add 5ec8048e-f25b-11ec-b939-0242ac120002 "attack_boost" 0.3 multiply_base
