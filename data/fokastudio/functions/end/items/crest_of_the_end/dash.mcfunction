...
execute positioned ~ ~0.18 ~ unless block ^ ^ ^0.6 #fokastudio:end/non_solid run tag @s remove foka.crest_of_the_end.dashing
execute positioned ~ ~0.18 ~ if block ^ ^ ^0.6 #fokastudio:end/non_solid run tp @s ^ ^ ^0.6
