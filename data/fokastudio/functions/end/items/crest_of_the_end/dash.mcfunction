execute as @e[distance=..1,tag=!foka.crest_of_the_end.dashing] unless score @s foka.items.crest_of_the_end.curse_cooldown matches 1.. at @s run function fokastudio:end/items/crest_of_the_end/effects_dash_through
