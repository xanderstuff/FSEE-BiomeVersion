...
tellraw @s ["\n",{"text":"Throw these items over the","color":"#EEEEEE"}," ",{"text":"Altar of the Accursed","color":"#B80000"}," ",{"text":"to craft powerful gear","color":"#EEEEEE"},"\n\n\n\n\n"]
...
tellraw @s [{"text":"Sabrewing","color":"#FFE853","bold":true},"\n",{"text":"Bow","bold":false,"color":"#954D00"},{"text":" + ","bold":false,"color":"#EEEEEE"},{"text":"10 Feathers","bold":false,"color":"yellow"},{"text":" + ","bold":false,"color":"#EEEEEE"},{"text":"12","bold":false,"color":"#EEEEEE"}," ",{"text":"Gold Ingots","bold":false,"color":"yellow"},{"text":" + ","bold":false,"color":"#EEEEEE"},{"text":"Netherite Ingot","bold":false,"color":"#545454"},"\n\n\n"]
