...
tellraw @s [{"text":"Pandora's Barrel","color":"#934C00","bold":true},"\n",{"text":"Barrel","bold":false,"color":"#934C00"},{"text":" + ","bold":false,"color":"#EEEEEE"},{"text":"Block of Iron","bold":false,"color":"#C3C3C3"},{"text":" + ","bold":false,"color":"#EEEEEE"},{"text":"Block of Gold","bold":false,"color":"yellow"},"\n\n"]

tellraw @s [{"text":"Shattered Conduit","color":"dark_purple","bold":true},"\n",{"text":"Conduit","bold":false,"color":"aqua"},"\n\n"]
