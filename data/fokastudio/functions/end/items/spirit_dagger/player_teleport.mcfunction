...
## Visuals
# Sweep
particle minecraft:sweep_attack ~ ~-.4 ~1.5 0 0.2 0 0 1 force @a[distance=..64]
particle minecraft:sweep_attack ~ ~-.4 ~-1.5 0 0.2 0 0 1 force @a[distance=..64]
particle minecraft:sweep_attack ~1.5 ~-.4 ~ 0 0.2 0 0 1 force @a[distance=..64]
particle minecraft:sweep_attack ~-1.5 ~-.4 ~ 0 0.2 0 0 1 force @a[distance=..64]

particle minecraft:sweep_attack ~1.1 ~-.4 ~1.1 0 0.2 0 0 1 force @a[distance=..64]
particle minecraft:sweep_attack ~1.1 ~-.4 ~-1.1 0 0.2 0 0 1 force @a[distance=..64]
particle minecraft:sweep_attack ~-1.1 ~-.4 ~1.1 0 0.2 0 0 1 force @a[distance=..64]
particle minecraft:sweep_attack ~-1.1 ~-.4 ~-1.1 0 0.2 0 0 1 force @a[distance=..64]
...
playsound minecraft:item.trident.riptide_2 player @a ~ ~ ~ 1 0.75
