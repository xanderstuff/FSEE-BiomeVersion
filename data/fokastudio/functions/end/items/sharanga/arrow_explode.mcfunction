...
playsound minecraft:entity.generic.explode player @a ~ ~ ~ 1.7 1.1
...
execute as @e[distance=..3,type=!#fokastudio:end/invalid_targets_no_player] run function fokastudio:end/items/sharanga/damage
