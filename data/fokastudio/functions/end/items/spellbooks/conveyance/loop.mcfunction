...
execute if score @s foka.misc matches 71.. run kill @s
...
execute unless block ^ ^ ^1 #fokastudio:end/non_solid run function fokastudio:end/items/spellbooks/conveyance/hit_block
