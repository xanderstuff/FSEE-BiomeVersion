...
execute if score #damage foka.misc matches 320.. run advancement grant @p[predicate=fokastudio:end/items/holding_dragonblade,predicate=fokastudio:end/utils/player/is_sneaking] only fokastudio:end/dragons_den/kaliyah
