...
scoreboard players set #2 foka.misc 22
scoreboard players operation #extra foka.misc = #enchant foka.misc
scoreboard players operation #extra foka.misc *= #2 foka.misc
...
# Cool little visuals
execute at @p[predicate=fokastudio:end/items/holding_dragonblade,predicate=fokastudio:end/utils/player/is_sneaking] facing entity @s eyes rotated ~ 0 positioned ^ ^1.15 ^1 run function fokastudio:end/items/dragonblade/punch/special_fx/particle_aec_spawn
