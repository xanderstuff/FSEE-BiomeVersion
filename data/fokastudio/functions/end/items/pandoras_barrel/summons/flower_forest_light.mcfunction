loot spawn ~ ~1.7 ~ loot fokastudio:end/pandoras_barrel_drops/flower_forest
execute if predicate fokastudio:end/utils/chance/15percent run loot spawn ~ ~1.7 ~ loot fokastudio:end/pandoras_barrel_drops/flower_forest
...
execute if predicate fokastudio:end/utils/chance/30percent run summon bee ~ ~1.7 ~
execute if predicate fokastudio:end/utils/chance/30percent run summon bee ~ ~1.7 ~


execute if predicate fokastudio:end/utils/chance/25percent run function fokastudio:end/items/pandoras_barrel/summons/flower_forest_light
