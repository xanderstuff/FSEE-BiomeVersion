...
#execute if score foka.config foka.config.X matches 1 run tellraw @s {"text":"Enabled/Disabled","color":"#91FF7B/#FF7B7B"}
...
execute if score foka.config foka.config.auto_butcher.phantoms matches 1 run tellraw @s {"text":"Enabled/Disabled","color":"#91FF7B/#FF7B7B"}
...
execute if score foka.config foka.config.auto_butcher.silverfish matches 1 run tellraw @s {"text":"Enabled/Disabled","color":"#91FF7B/#FF7B7B"}
...
execute if score foka.config foka.config.custom_music matches 1 run tellraw @s {"text":"Enabled/Disabled","color":"#91FF7B/#FF7B7B"}
...
execute if score foka.config foka.config.enter_end_effects.flavor_text matches 1 run tellraw @s {"text":"Enabled/Disabled","color":"#91FF7B/#FF7B7B"}
...
execute if score foka.config foka.config.enter_end_effects.sounds matches 1 run tellraw @s {"text":"Enabled/Disabled","color":"#91FF7B/#FF7B7B"}
...
execute if score foka.config foka.config.post_gen.load_main_island matches 1 run tellraw @s {"text":"Enabled/Disabled","color":"#91FF7B/#FF7B7B"}
...
execute if score foka.config foka.config.mod_support.expanded_structure_blocks matches 1 run tellraw @s {"text":"Enabled/Disabled","color":"#91FF7B/#FF7B7B"}
...
execute if score foka.config foka.config.join_message matches 1 run tellraw @s {"text":"Enabled/Disabled","color":"#91FF7B/#FF7B7B"}
...
execute if score foka.config foka.config.teleport_to_platform matches 1 run tellraw @s {"text":"Enabled/Disabled","color":"#91FF7B/#FF7B7B"}
