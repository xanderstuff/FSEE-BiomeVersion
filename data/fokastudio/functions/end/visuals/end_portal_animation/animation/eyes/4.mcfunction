...
execute as @e[type=armor_stand,tag=foka.end_portal_animation.eye_4_1,limit=1,sort=nearest] at @s run tp @s ~ ~ ~ ~0.9 ~
execute as @e[type=armor_stand,tag=foka.end_portal_animation.eye_4_2,limit=1,sort=nearest] at @s run tp @s ~ ~ ~ ~-0.9 ~
