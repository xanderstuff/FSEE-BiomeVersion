...
execute as @p[predicate=fokastudio:end/void_fishing/holding_fishing_rod/any] run function fokastudio:end/mechanics/void_fishing/as_player

execute positioned ~ ~.5 ~ run function fokastudio:end/mechanics/void_fishing/decide_drop
