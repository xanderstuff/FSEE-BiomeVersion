...
execute unless score #foka.is_fabric foka.misc matches 1 unless score #foka.is_forge foka.misc matches 1 run tellraw @s {"text":"Custom End Music","color":"#C076E5","hoverEvent": {"action": "show_text","contents": [{"text": "foka.config.custom_music","color":"#DFDFDF"},"\n",{"text": "Click to edit","color":"#CEADD6"},"\n",{"text":"Default: ","color":"#C8ADD6"},{"text":"Disabled","color":"#FF7B7B"}]},"clickEvent": {"action": "suggest_command","value": "/scoreboard players set #foka.config foka.config.custom_music "}}
execute unless score #foka.is_fabric foka.misc matches 1 unless score #foka.is_forge foka.misc matches 1 run tellraw @s {"text":"Replaces default End Music with custom one. Requires a resource pack that I am still yet to make, so this setting is useless for now","color":"#C8ADD6"}
execute unless score #foka.is_fabric foka.misc matches 1 unless score #foka.is_forge foka.misc matches 1 run execute if score #foka.config foka.config.custom_music matches 1 run tellraw @s {"text":"Enabled","color":"#91FF7B"}
execute unless score #foka.is_fabric foka.misc matches 1 unless score #foka.is_forge foka.misc matches 1 run execute if score #foka.config foka.config.custom_music matches 0 run tellraw @s {"text":"Disabled","color":"#FF7B7B"}
execute unless score #foka.is_fabric foka.misc matches 1 unless score #foka.is_forge foka.misc matches 1 run tellraw @s " "
