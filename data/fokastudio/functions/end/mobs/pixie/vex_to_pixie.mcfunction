# 8% chance to replace a Pixie with an Allay on spawn
scoreboard players set #foka.spawn_allay foka.misc 0
execute if predicate fokastudio:end/utils/chance/8percent run scoreboard players set #foka.spawn_allay foka.misc 1
