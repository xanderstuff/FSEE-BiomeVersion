...
execute as @e[type=marker,tag=foka.dragon_marker] at @s run summon item ~ ~ ~ {NoGravity:1b,Glowing:1b,Age:-32768,PickupDelay:100,Motion:[0.0,-0.6,0.0],Item:{id:"minecraft:amethyst_shard",Count:1b,tag:{display:{Name:'{"translate":"Ender Insignia","color":"#A25AFF","italic":false}',Lore:['{"translate":"Greatly increases life regen when","color":"gray","italic":false}','{"translate":"held and not moving","color":"gray","italic":false}','{"text":"The End is withing your hands","font":"illageralt","color":"dark_purple","italic":false}']},CustomModelData:90000,foka.special_item:"ender_insignia",Enchantments:[{}]}}}
