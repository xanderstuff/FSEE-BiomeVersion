...
execute if entity @e[tag=foka.altar_of_the_accursed.bow,distance=..1.5] if entity @e[tag=foka.altar_of_the_accursed.10_feathers,distance=..1.5] if entity @e[tag=foka.altar_of_the_accursed.12_gold_ingots,distance=..1.5] if entity @e[tag=foka.altar_of_the_accursed.netherite_ingot,distance=..1.5] run function fokastudio:end/floor_crafting/items/craft_sabrewing

execute if entity @e[tag=foka.altar_of_the_accursed.enchanted_book,distance=..1.5] run function fokastudio:end/floor_crafting/items/craft_cursed_tome

execute if entity @e[tag=foka.altar_of_the_accursed.wooden_sword,distance=..1.5] run function fokastudio:end/floor_crafting/items/craft_ancient_wooden_sword

execute if entity @e[tag=foka.altar_of_the_accursed.stick,distance=..1.5] if entity @e[tag=foka.altar_of_the_accursed.16_leather,distance=..1.5] if entity @e[tag=foka.altar_of_the_accursed.4_bamboo,distance=..1.5] run function fokastudio:end/floor_crafting/items/craft_battlestick
