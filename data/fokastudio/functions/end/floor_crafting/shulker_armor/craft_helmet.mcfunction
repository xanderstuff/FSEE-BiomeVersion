data modify storage fokastudio:end/temp enchants set from entity @e[tag=foka.altar_of_the_accursed.netherite_helmet,distance=..1,limit=1] Item.tag.Enchantments
