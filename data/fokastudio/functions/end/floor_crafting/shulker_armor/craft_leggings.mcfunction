data modify storage fokastudio:end/temp enchants set from entity @e[tag=foka.altar_of_the_accursed.netherite_leggings,distance=..1.5,limit=1] Item.tag.Enchantments

kill @e[tag=foka.altar_of_the_accursed.shulker_shells,distance=..1.5,limit=1]
kill @e[tag=foka.altar_of_the_accursed.netherite_leggings,distance=..1.5,limit=1]
