...
#init modules
function dutils:base/init
function dutils:math/init
function dutils:world/utils/init

#schedule
schedule function dutils:load_message 2s
schedule function dutils:main 2t
