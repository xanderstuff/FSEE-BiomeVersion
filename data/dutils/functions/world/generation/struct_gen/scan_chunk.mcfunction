...
execute positioned ~ 254 ~ run function dutils:world/generation/struct_gen/scan_chunk_2
execute if score $world.in_0 du_data matches 0 positioned ~ 0 ~ run function dutils:world/generation/struct_gen/sky/start

#bottom solid -> surface or cavern -> surface, cave, sky
#bottom not solid -> void or sky -> void, surface, sky
