...
execute if score $world.out_0 du_data matches 1 if data storage dutils:temp list[0].biomes[0] run function dutils:world/generation/struct_gen/surface/check_biomes 
