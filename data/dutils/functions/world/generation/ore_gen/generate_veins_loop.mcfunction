...
#> $world.in_9: placement restriction
...
execute store result score $world.in_9 du_data run data get storage dutils:temp list[0].ignorePlacement

function dutils:world/generation/ore_gen/displace_x

scoreboard players remove $world.in_7 du_data 1
execute if score $world.in_7 du_data matches 1.. run function dutils:world/generation/ore_gen/generate_veins_loop
