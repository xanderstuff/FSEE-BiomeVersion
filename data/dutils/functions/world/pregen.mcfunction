...
execute if score @s pregen_radius matches 1.. if data storage dutils:temp pregen run tellraw @p [{"text":"A pregen task is already running.","color":"red"}]
execute if score @s pregen_radius matches 1.. unless data storage dutils:temp pregen run function dutils:world/pregen/setup
