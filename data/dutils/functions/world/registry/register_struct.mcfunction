...
# data merge storage dutils:temp {object:{dimension:"minecraft:overworld",biomes:["biome_1","biome_2",...],isBlacklist:0b}}
#
# $world.out_0 du_data: Returns -1 if registering struct failed. Otherwise, returns generated structure registry ID.
# Keep track of this number in a fake player scoreboard value. The function tag `#dutils:world_gen/struct` will have `$world.in_0 du_data` set to the structure's registry ID.
...
execute if score $world.out_0 du_data matches 0 run function dutils:world/registry/register_struct_2

#reset temp
data modify storage dutils:temp object set value {}
