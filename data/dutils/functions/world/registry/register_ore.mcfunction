...
# Keep track of this number in a fake player scoreboard value. The function tag `#dutils:world_gen/ore` will have `$world.in_0 du_data` set to the structure's registry ID.
...
execute if score $world.out_0 du_data matches 0 run function dutils:world/registry/register_ore_2
