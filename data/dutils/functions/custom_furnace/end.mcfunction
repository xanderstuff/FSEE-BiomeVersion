...
execute if block ~ ~ ~ minecraft:furnace run function #dutils:recipes/furnace
execute if block ~ ~ ~ minecraft:blast_furnace run function #dutils:recipes/blast_furnace
execute if block ~ ~ ~ minecraft:smoker run function #dutils:recipes/smoker
